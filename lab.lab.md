...
> aside negative
>
> If those two variables are empty, set them again before going further. They are
> not the same value and never will be: the model answers from `global`, your
> agent runs in a region. Setting them equal produces a 404 that names the model
