...
```
<walkthrough-editor-open-file filePath="cloudshell_open/workshop-agentic-sdlc-lab/scripts/dispatch.sh">scripts/dispatch.sh</walkthrough-editor-open-file> does quite a few things.
